<?php 
    ...
    $id =(int)$_GET['id'];
    $data =select ("SELECT*FROM form_2 WHERE id =$id")[0];

    if(isset($_POST['ubah'])) {
        if(update_data_2($_POST) > 0) {
            echo "<script>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Form 2 PSN Ubah Data</h4>
                        ...
                        <div class="col-sm-9 col-md-6 col-lg-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" required name="kabupaten" value ="<?=$data['kabupaten']?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-9 col-md-6 col-lg-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="number" class="form-control" required name="jml_rumah" value ="<?=$data['jml_rumah']?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-9 col-md-6 col-lg-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="number" class="form-control" required name="jml_bak_ptf" value ="<?=$data['jml_bak_pstf']?>">
                                    </div>
                                </div>
                            </div>
                        </div>
