<?php 
    ...
    $id =(int)$_GET['id'];
    $data =select ("SELECT*FROM data_rt WHERE id =$id")[0];
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Form PSN Input Data RT</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.php" class="text-muted">Home</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Input Data RT</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-9 col-md-6 col-lg-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" required name="no_rt" value ="<?=$data['no_rt']?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-9 col-md-6 col-lg-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="number" class="form-control" required name="jml_rmh_diperiksa" value ="<?=$data['jml_rmh_diperiksa']?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-9 col-md-6 col-lg-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="number" class="form-control" required name="jml_rmh_pstf" value ="<?=$data['jml_rmh_pstf']?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-9 col-md-6 col-lg-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="number" class="form-control" required name="jml_bak_ptf" value ="<?=$data['jml_bak_ptf']?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-9 col-md-6 col-lg-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="number" class="form-control" required name="jml_dispen" value ="<?=$data['jml_dispen']?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-9 col-md-6 col-lg-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="number" class="form-control" required name="jml_dispen_pstf" value ="<?=$data['jml_dispen_pstf']?>">
                                    </div>
                                </div>
                            </div>
                        </div>
