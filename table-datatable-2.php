            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Data PSN</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.php" class="text-muted">Home</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Data Form 2</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td width "158" class="text-center">
                                                    <a href="ubah-data-2.php?id=<?=$data['id'];?>" name ="ubah" class= "btn btn-success">Ubah</a>
                                                    <a href="hapus-data-2.php?id=<?=$data['id'];?>" name ="hapus"class= "btn btn-danger">Hapus</a>
                                                </td>
